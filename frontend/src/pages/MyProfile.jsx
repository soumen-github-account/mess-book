...
const MyProfile = () => {
  ...
  const {userData,setToken, setUserData, token, backendUrl, loadUserProfileData} = useContext(SellersContext)
  ...
  return userData && (
    ...
    <div className='max-w-30'>
      <p onClick={logout} className='flex items-center justify-center p-2 border-2 rounded-full cursor-pointer'>Logout</p>
    </div>
  </div>
  )
}
